...
def attack(char_name, char_class):
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику '
                f'sравный {5 + randint(-3, -1)}')
    return f'{char_name} не нанёс урон противнику'


def defence(char_name, char_class):
    """Defencing from enemy module"""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Trying special options for different characters"""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Function for training character"""
    if char_class == 'warrior':
...
def choice_char_class():
    """Function for chosing the character"""
    approve_choice = None
    char_class = None
